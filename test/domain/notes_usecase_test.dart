...
import 'package:flutter_notes/features/notes/domain/usecases/notes_usecase/notes_usecase_impl.dart';
...
void main() {
  ...
  group('NotesUsecase', () {
    test('should return a list of NoteEntity when getAllNotes is called successfully', () async {
      ...
      final result = await notesUsecase.getAllNotes();
    ...
    test('should successfully add a note', () async {
      ...
      final result = await notesUsecase.addNote(noteEntity: noteEntity);
